...
class Order extends BaseModel
{
    ...
    public function addItem($orderId, $gameId, $price)
    {
        $query = "INSERT INTO order_items (order_id, game_id, price) 
    ...
    public function getRevenueStatsByMonth($year)
    {
    ...
    public function getRevenueStatsByYear()
    {
        $query = "SELECT YEAR(created_at) as year, SUM(total_amount) as revenue 
                  FROM orders 
                  WHERE status IN ('approved', 'completed') 
    ...
    {
        $query = "SELECT gc.name, SUM(oi.price) as total_sales 
                  FROM order_items oi 
                  JOIN games g ON oi.game_id = g.id 
